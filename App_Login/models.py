...
# automatically creates one to one objects
...
class MyUserManager(BaseUserManager):
  ...
  """ Deal with email as unique identifier """
...
# When user will create automatically profile is also created
...
# When user will change profile is also changed
